...
public class SegmentedTextFrame extends JFrame {
	...
	/**
	 * Initialise la fenêtre en fonction de certains paramètres de base nécessaires
	 * à sa création.<br>
	 * Cette méthode est nécessaire pour appeler la méthode {@link #start} qui
	 * affiche la fenêtre.
	 * 
	 * @param text
	 *            le texte segmenté
	 * @param startingPhrase
	 *            le numéro du premier segment à afficher (en partant de 0)
	 * @param font
	 *            la police du texte
	 * @param x
	 *            la position x de la fenêtre (en pixels)
	 * @param y
	 *            la position y de la fenêtre (en pixels)
	 * @param width
	 *            la largeur de la fenêtre (en cm)
	 * @param height
	 *            la hauteur de la fenêtre (en cm)
	 */
	...
	/**
	 * Met en place une marge automatique sur les côtés proportionnelle à la largeur
	 * de la fenêtre.<br>
	 * Le nombre <i>marginFactor</i> correspond au rapport de la marge sur la
	 * largeur de la fenêtre
	 * lorsque la fenêtre est en plein écran.<br>
	 * Par exemple, si <i>marginFactor</i> = 5 (valeur conseillée), un espacement
	 * égal à largeur de la fenêtre/5 sera mis en place
	 * lorsque la fenêtre sera en plein écran. Ce rapport diminue au fur et à mesure
	 * que la taille de la fenêtre diminue
	 * afin de ne pas écraser le texte.
	 * 
	 * @param marginFactor
	 *            la facteur proportionnel à la largeur de la fenêtre (par défaut =
	 *            0)
	 */
	@Deprecated
	...
	/**
	 * Met la fenêtre en plein écran (l'utilisateur voit uniquement la fenêtre
	 * d'exercice).<br>
	...
	/**
	 * Active ou désactive le traitement des textes à trou, c'est-à-dire que si
	 * cette option est activée (par défaut),
	 * toutes les expressions entre crochets seront remplacées par des
	 * underscore.<br>
	 * Cette méthode doit être appelée avant d'afficher la fenêtre.
	 * 
	 * @param holeTreatment
	 *            <code>true</code> si l'option de traitement de textes à trou doit
	 *            être activé, <code>false</code> sinon
	 */
