...
public class FenetreParametre extends JFrame {
	...
	public class PanneauParam extends JPanel {
		...
		public PanneauParam(FenetreParametre fen) throws NumberFormatException, IOException {
			...
			bgColorComboBox = fastComboBox(controleur, getColorNames());
			bgColorComboBox.setRenderer(new ColorCellRenderer());
			...
			correctColorComboBox = fastComboBox(controleur, getColorNames());
			correctColorComboBox.setRenderer(new ColorCellRenderer());
		...
		public void savePreferences(ReadMode readMode) {
			Parametres param = params.get(readMode);
			param.bgColor = stringToColor((String) bgColorComboBox.getSelectedItem());
			param.rightColor = stringToColor((String) rightColorComboBox.getSelectedItem());
			param.wrongColor = stringToColor((String) wrongColorComboBox.getSelectedItem());
			param.correctionColor = stringToColor((String) correctColorComboBox.getSelectedItem());
	...
	public void lancerExercice() {
		...
		Panneau.premierSegment = getCurrentParameters().startingPhrase;
		Panneau.defautNBEssaisParSegment = getCurrentParameters().nbFautesTolerees;
		fenetre.start();
	}
